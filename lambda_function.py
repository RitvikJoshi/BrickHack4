...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Party Menu Planner. " \
                    "Please tell me your preferred meal type by saying, " \
                    "suggest me a recipe which is dessert," \
                    "I can suggest options in vegaterian nonveg and dessert"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please tell me your preferred meal type by saying, " \
                    "suggest me a recipe which is dessert," \
                    "I can suggest options in vegaterian nonveg and desserts"
...
def create_favorite_color_attributes(category):
    return {"Category": category}
    
def create_favorite_recipe_attributes(recipe):
...
def set_category_in_session(intent, session):
    ...
    if 'Color' in intent['slots'] :
        category = intent['slots']['Color']['value']
        if category != "" :
            session_attributes = create_favorite_color_attributes(category)
            chosen_recipe=getRecipe(category)
            print(chosen_recipe)
            if(chosen_recipe==""):
                ...
                speech_output = "The top  " + category + " party recipes are " + chosen_recipe +" Which one would you like to add to cart?"
    ...
    #     recipe = intent['slots']['Recipe']['value']
    #     session_attributes = create_favorite_recipe_attributes(recipe)
    #     ingridients=getIngrident(recipe)
